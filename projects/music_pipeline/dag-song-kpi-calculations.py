...
# Constants
BUCKET_NAME = 'deborah-de-projects-2026'
SONGS_FILE_PATH = 'music-pipeline/raw/songs.csv'
USERS_FILE_PATH = 'music-pipeline/raw/users.csv'
STREAMS_PREFIX = 'music-pipeline/raw/streams/'
ARCHIVE_PREFIX = 'music-pipeline/raw/streams/archived/'
